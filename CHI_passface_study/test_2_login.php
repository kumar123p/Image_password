...
$result = mysqli_query($link , "SELECT p3 FROM credentials WHERE uname = '$test_uname'");
//echo "something";
...
<body>
  <div align="center">
    <h1 class="h1">Select third image! (3/4)</h1>
  ...
  <div align="center">
    <a href='./test_3_login.php'><button name="button_next" class="btn" type="button" onclick="next()">Next</button></a>
  </div>
</body>
